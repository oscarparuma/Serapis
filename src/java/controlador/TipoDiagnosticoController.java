...
import fachada.TipoDiagnosticoFacade;
...
public class TipoDiagnosticoController implements Serializable {
    ...
    private TipoDiagnostico current;
    private DataModel items = null;
    @EJB
    private fachada.TipoDiagnosticoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (TipoDiagnostico) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoDiagnosticoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoDiagnosticoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoDiagnosticoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public TipoDiagnostico getTipoDiagnostico(java.lang.String id) {
    ...
    public static class TipoDiagnosticoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoDiagnostico) {
                ...
                return getStringKey(o.getCodigoTipoDiagnostico());
            } else {
