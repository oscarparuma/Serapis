...
@Named("religionController")
@SessionScoped
public class ReligionController implements Serializable {

    private Religion current;
    private DataModel items = null;
    @EJB
    private fachada.ReligionFacade ejbFacade;
    ...
    public Religion getSelected() {
        if (current == null) {
            current = new Religion();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ReligionFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Religion) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ReligionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ReligionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ReligionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Religion getReligion(java.lang.Integer id) {
    ...
    public static class ReligionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Religion) {
                ...
                return getStringKey(o.getCodigoReligion());
            } else {
