...
import fachada.EstadofacturaFacade;
...
@Named("estadofacturaController")
@SessionScoped
public class EstadofacturaController implements Serializable {

    private Estadofactura current;
    private DataModel items = null;
    @EJB
    private fachada.EstadofacturaFacade ejbFacade;
    ...
    public Estadofactura getSelected() {
        if (current == null) {
            current = new Estadofactura();
            selectedItemIndex = -1;
        }
        return current;
    }

    private EstadofacturaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Estadofactura) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EstadofacturaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EstadofacturaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EstadofacturaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Estadofactura getEstadofactura(java.lang.String id) {
    ...
    public static class EstadofacturaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estadofactura) {
                ...
                return getStringKey(o.getCodigoEstadoFactura());
            } else {
