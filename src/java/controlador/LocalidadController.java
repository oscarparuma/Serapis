...
import fachada.LocalidadFacade;
...
public class LocalidadController implements Serializable {
    ...
    @EJB
    private fachada.LocalidadFacade ejbFacade;
    ...
    public Localidad getLocalidad(java.lang.String id) {
    ...
    public static class LocalidadControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Localidad) {
                ...
                return getStringKey(o.getCodigoLocalidad());
            } else {
