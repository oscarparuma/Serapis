...
public class ConsultamedicaFacade extends AbstractFacade<Consultamedica> {
    ...
    public ConsultamedicaFacade() {
     ...
     public List<Consultamedica> findRange(int[] range, Citapersona c) {
        javax.persistence.Query q = getEntityManager().createQuery("select s from Consultamedica s where s.codigoCita=?1");
        q.setParameter(1, c);
