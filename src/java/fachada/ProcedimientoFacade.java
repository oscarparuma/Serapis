...
public class ProcedimientoFacade extends AbstractFacade<Procedimiento> {
    ...
    public List<Procedimiento> findRange(int[] range, Citapersona c) {
        javax.persistence.Query q = getEntityManager().createQuery("select s from Procedimiento s where s.codigoCita=?1");
        q.setParameter(1, c);
